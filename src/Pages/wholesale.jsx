    ...
    return (
        ...
        <main className="bg-[url('/assets/all-bg.jpg')] bg-cover bg-top bg-no-repeat">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <section className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-12 py-16">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 items-start gap-12 py-16">
