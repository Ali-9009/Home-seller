    ...
    return (
        ...
        <main className="bg-[url('/assets/all-bg.jpg')] bg-cover bg-top bg-no-repeat">
            ...
            <div className="max-w-7xl mx-auto px-6">
                <section className="grid grid-cols-1 items-center gap-12 md:py-16 py-8 text-left md:text-center">
                ...
                <section className="py-8 md:pb-16">
                    <div className="">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
                            ...
                            {/* Card 1 */}
                            <div className="bg-white/30 border border-[#DADADA] rounded-xl p-6 text-center md:col-span-2">
                            ...
                            {/* Card 4 */}
                            <div className="bg-white/30 border border-[#DADADA] rounded-xl p-6 text-center md:col-span-2 md:col-start-2">
                                <div className="flex justify-center mb-4">
                ...
                <section className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-12 pt-8 pb-16">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-lg text-(--text-color)">
                            HomeSellers Real Estate Group is ideal for agents who work
                        </p>

                        <div className="flex items-start gap-4 max-w-lg mt-4">
                ...
                <section id="join" className="md:py-16 pb-12 flex justify-center">
                    <div className="max-w-4xl w-full text-center">
                        ...
                        <div className="bg-white/30 rounded-xl shadow-sm border border-[#DADADA] p-8">
