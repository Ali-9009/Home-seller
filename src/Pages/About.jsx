    ...
    return (
        ...
        <main className="bg-[url('/assets/all-bg.jpg')] bg-cover bg-top bg-no-repeat">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 md:pb-16 py-8">
                ...
                <section className="md:pb-12 pb-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        {/* Right Grid */}
                        <div className="bg-white/30 text-(--text-color) border border-gray-200 rounded-xl overflow-hidden grid grid-cols-1 sm:grid-cols-2">
